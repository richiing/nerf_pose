...
config.NERF = edict()
config.NERF.DIM = 64
config.NERF.USE_FEAT_LEVEL = [0, 1, 2]
config.NERF.FEAT_BEGIN_LAYER = 0
config.NERF.FEAT_END_LAYER = 1
config.NERF.PRETRAINED = ''
...
config.NETWORK.ORI_IMAGE_SIZE = np.array([80, 80])
